  ...
  const submenu: MenuItemConstructorOptions[] = [
    {
      ...
      click() {
        void shell.openExternal('https://github.com/vercel/nimbus');
      }
    },
    {
      label: 'Report Issue',
...
- [ ] Your Nimbus version is **${version}**. Please verify you're using the [latest](https://github.com/vercel/nimbus/releases/latest) Nimbus version
- [ ] I have searched the [issues](https://github.com/vercel/nimbus/issues) of this repo and believe that this is not a duplicate
---
...
- **Is the issue reproducible in vanilla Nimbus?**
<!-- 👉 Replace with info if applicable, or Is Vanilla. (Vanilla means Nimbus without any add-ons or extras. Straight out of the box.) -->
...
<details><summary><strong>nimbus.json contents</strong></summary>
...
\`\`\`
        ...
        const issueURL = `https://github.com/vercel/nimbus/issues/new?body=${encodeURIComponent(body)}`;
        const copyAndSend = () => {
          clipboard.writeText(body);
          void shell.openExternal(
            `https://github.com/vercel/nimbus/issues/new?body=${encodeURIComponent(
