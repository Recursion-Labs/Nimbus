...
import type {TermProps} from '../../typings/nimbus';
...
> {
    ...
    if (!props.term) {
      ...
      if (props.webGLRenderer) {
        if (needTransparency) {
          ...
          // Experimental WebGL renderer needs some more glue-code to make it work on Nimbus.
  ...
  getTermDocument() {
    console.warn(
      'The underlying terminal engine of Nimbus no longer ' +
