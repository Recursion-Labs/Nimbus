...
import NimbusContainer from './containers/nimbus';
import rpc from './rpc';
...
console.log('=== Setting up RPC ready handler ===');
// Render React app when RPC is ready
rpc.on('ready', () => {
...
console.log('=== RPC ready handler registered ===');
