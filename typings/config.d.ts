...
type rootConfigOptions = {
  /**
   * if `true` (default), Nimbus will update plugins every 5 hours
   * you can also set it to a custom time e.g. `1d` or `2h`
   */
  autoUpdatePlugins: boolean | string;
  /** if `true` nimbus will be set as the default protocol client for SSH */
  defaultSSHApp: boolean;
  /** if `true` nimbus will not check for updates */
...
type profileConfigOptions = {
  ...
  /** if `false` Nimbus will use ligatures provided by some fonts */
